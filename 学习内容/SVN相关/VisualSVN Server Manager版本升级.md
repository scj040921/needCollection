...
10. **请确保您的 HTTPS 证书允许使用 TLS 1.3**：
    ...
    启动**VisualSVN 服务器管理器**控制台。 点击**操作 | 属性**。 点击**“证书”**选项卡。
        ...
        您需要**生成并安装新的 TLS 证书** 来解决此问题。请参阅文章 [KB134：为 VisualSVN 服务器配置 SSL 证书](https://www.visualsvn.com/support/topic/00134/ "KB134：为 VisualSVN 服务器配置 SSL 证书") 以获取相关说明。